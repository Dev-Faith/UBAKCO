    ...
    <section className="bg-[#EFEFEF] 2xl:w-screen rounded-tl-[50px] lg:pb-[514px] rounded-tr-[50px] overflow-hidden pb-[490px] mt-[-32px] lg:mt-0 flex justify-center">
      <div className="w-full px-[16px] sm:px-[60px] max-w-[1440px]">
        ...
        <div className=" w-full mt-[100px] flex justify-center">
          <div className="separator w-full border-t border-[#CACACA] py-[75px] grid grid-cols-1 lg:grid-cols-2 lg:gap-y-[115px] gap-y-[24px]  relative justify-center ">
                ...
                className={`${
                  featuresCardItems.length - 1 !== index
                    ? `${
                      ...
                      } border-b-[1px] lg:border-b-0  border-[#CACACA]`
                    : ""
                }  pb-[24px] lg:pb-0 `}
              >
                <FeatureCard
