...
export default function Header() {
  ...
  <div className="w-full max-w-[1440px] mx-auto flex items-center justify-between px-[16px] sm:px-[60px] lg:px-[60px] py-[24px]">
        <Link href="/">
          <Image src="/images/logo.png" alt="UBAKCO" width={153} height={40} className="cursor-pointer" />
        </Link>
        <Navbar />
        <div className="hidden lg:flex">
          ...
          <Button fn="quote" className="ml-[16px] cursor-pointer">Request a Quote</Button>
        </div>
        <button
