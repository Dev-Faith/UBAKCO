...
export default function Whatdrives() {
  ...
  return (
    <div className="w-full bg-[#EFEFEF] flex justify-center">
      <section className="max-w-[1440px] w-full pt-[70px] lg:pt-[120px] lg:pb-[100px] px-[16px] md:px-[60px] lg:px-[60px] relative overflow-hidden">
        <motion.h1
          ref={ref}
          initial={{ opacity: 0, y: 40 }}
          animate={controls}
          className="w-[198px] lg:w-[265px] font-semibold lg:font-bold text-[32px]/[48px] lg:text-[42px]/[54.6px] font-display tracking-[-0.02em] md:text-[42px]/[54.6px] md:w-[265px]"
        >
          What Drives Ubacko
        </motion.h1>
          ...
          {driveList.map((drive, index) => (
            <div key={index} className="lg:w-[516px] w-[370px] md:w-full flex flex-col gap-[16px]">
              <motion.h1
                initial={{ opacity: 0, y: 40 }}
                animate={controls}
                className="text-[#EA5C2B] text-[26px]/[42px]  text-[32px]/[42px] font-bold tracking-[0.02em] font-display"
              >
                {drive.title}
              </motion.h1>
              <motion.p
                initial={{ opacity: 0, y: 40 }}
                animate={controls}
                className="text-[18px]/[32px] font-sans font-[400] tracking-[0.05em] "
              >
                {drive.desc}
              </motion.p>
            </div>
