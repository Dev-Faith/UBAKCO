...
const WedLove = () => {
  ...
  return (
    <section className="bg-[#EDEDED] pt-[70px] lg:pt-[150px] px-[16px] lg:px-[60px] rounded-t-[20px] relative mt-[-24px] pb-[116px] overflow-hidden">
      ...
      <div className="flex flex-col gap-[32px]">
        <h1 className=" text-[32px]/[48px] lg:text-[42px]/[54.6px] tracking-[-0.02em] w-[249px] lg:w-[447px] font-bold font-display">
          We’d love to hear from you
        </h1>
        <p className="text-[#323232] text-[18px]/[27px] tracking-[0.05em] lg:text-[28px]/[42px] w-[370px] lg:w-[631px]">
      ...
      <div className="flex lg:flex-row flex-col items-center border-y-[1px] border-[#CACACA] gap-[41px] lg:justify-between py-[40px] mt-[64px]">
        {address.map((item, index) => (
          ...
          >
            <h1 className="text-[#EA5C2B] font-bold text-[26px]/[42px] lg:text-[32px]/[42px] tracking-[-0.02em] font-display">
              {item.title}
            </h1>
            <p className="text-[#323232] font-[400] tracking-[0.02em] w-[300px] font-sans text-[20px]/[30px] lg:text-[28px]/[42px]">
              {item.desc}
            </p>
