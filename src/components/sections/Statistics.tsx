...
const Statistics = ({bg="#EFEFEF"}:{bg?:string}) => {
  ...
  return (
    <div className={`w-full bg-[${bg}] flex justify-center`}>
      <section className="max-w-[1440px] w-full pt-[32px] sm:pt-[100px] px-[16px] sm:px-[60px] pb-[64px] sm:pb-[128px]">
        <div className="relative border-y-[1px] border-[#CACACA] py-[40px] sm:mt-[55px] flex flex-col lg:flex-row lg:items-center lg:justify-between gap-[41px] lg:gap-0">
