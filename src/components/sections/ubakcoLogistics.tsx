...
const UbakcoLogistics = () => {
  return (
    <section className="bg-[#EFEFEF] px-[60px] py-[120px]">
      <div className="flex items-center justify-between 2xl:w-[1440px] mx-auto gap-[100px] flex-col lg:flex-row">
       <div className="flex flex-col gap-[64px]">
         <h1 className="font-display w-[434px] text-[42px]/[54.6px] font-bold tracking-[0.02em]">Ubakco Logistics Concierge</h1>
        <p className="text-[28px]/[42px] w-[434px] font-[400] tracking-[0.05em]">
       ...
       <Image src="/images/logistics.png" alt="Ubakco Logistics Concierge" width={621} height={676} className="w-[621px] h-[676px]"/>
      </div>
