  ...
  return (
    <section className="bg-[#EFEFEF] px-[16px] md:px-[60px] lg:px-[60px] py-[120px]">
      <div className="flex items-center md:items-start lg:justify-between 2xl:w-[1440px] mx-auto gap-[100px] flex-col lg:flex-row">
        <div className="flex flex-col gap-[24px] md:gap-[64px] lg:gap-[64px] ">
          <h1 className="font-display w-[300px] md:w-[400px] md:text-[42px]/[54.6px] lg:w-[434px] text-[32px]/[48px]  lg:text-[42px]/[54.6px] font-bold tracking-[0.02em]">
            Ubakco Logistics Concierge
          </h1>
          <p className=" text-[18px]/[27px] text-[#656565] md:w-[540px] lg:text-[28px]/[42px] w-[370px] lg:w-[434px] font-[400] tracking-[0.05em]">
