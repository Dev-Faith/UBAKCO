...
const Trusted = () => {
  ...
  return (
    <section className=" mt-[130px]  w-full relative pb-[150px]">
     <div className="flex flex-col gap-[32px] px-[60px]">
         <h1 className="font-display text-[60px]/[72px] font-bold w-[550px]">Trusted by Industry Leaders</h1>
      <p className="text-[28px]/[42px] font-sans font-regular w-[918px]">Proud to serve Nigeria's most prestigious companies and organizations</p>
     </div>
     <div className="flex justify-between items-center w-full p-0 mt-[94px] overflow-hidden">
        <Image src="/images/leftShadow.png" alt="Left Shadow" width={100} height={100} className="object-cover absolute left-0 z-10" />
            <div 
        ...
        <Image src="/images/rightShadow.png" alt="Right Shadow" width={100} height={100} className="object-cover absolute right-0 z-10" />
     </div>
    </section>
  );
};
