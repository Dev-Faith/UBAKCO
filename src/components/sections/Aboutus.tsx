...
const Aboutus = () => {
  return (
    <section className="relative lg:mt-[95px] overflow-hidden lg:h-[515px] h-[50vh]">
      ...
      <div className="absolute top-[30%] left-[16px] lg:left-[60px] flex flex-col gap-[12px] text-white">
        <h1 className="font-display font-bold  text-[24px]/[36px] lg:text-[48px]/[62.4px] tracking-[-0.02em] lg:w-full w-[273px]">About Us</h1>
        <p className="font-sans text-[14px]/[21px] lg:text-[18px]/[27px] w-[273px] lg:w-[572px]">Backed by 12+ years of experience, UBACKO is a trusted logistics partner for personal, corporate, and premium deliveries.</p>
      </div>
    </section>
  )
}
